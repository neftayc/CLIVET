...
class Producto(models.Model):
    ...
    unidadMedidaV = models.ForeignKey(
        UnidadMedida, related_name='ventas', verbose_name="U. medida para ventas")
    unidadMedidaC = models.ForeignKey(UnidadMedida, related_name='compras',
                                      verbose_name='U. medida de compras')
    ...
    existencia = models.PositiveIntegerField('Cantidad de Productos', default=0)
